export const example = `light red bags contain 1 bright white bag, 2 muted yellow bags.
...
export const input = `light orange bags contain 1 dark maroon bag, 3 dim maroon bags, 5 striped green bags, 2 pale aqua bags.
